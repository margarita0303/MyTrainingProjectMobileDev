...
import com.margaritalashina.mytrainingprojectmobiledev.databinding.ItemOnboardingTextBinding
import com.hannesdorfmann.adapterdelegates4.dsl.adapterDelegateViewBinding

// реализацию адаптера мы будем получать с помощью функции onboardingTextAdapterDelegate
