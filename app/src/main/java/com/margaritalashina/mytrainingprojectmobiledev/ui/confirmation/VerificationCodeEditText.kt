...
import com.margaritalashina.mytrainingprojectmobiledev.databinding.ViewVerificationCodeEditTextBinding
...
// разметку мы объявляем с тегом merge
// parent-ом будет наш view, но все view внутри merge располгаются согласно политике ConstraintLayout(можно и другое, мы так написали)

// с помощью ключевого @JvmOverloads создадутся все варианты конструкторов (с 1 параметром, с 2...)
