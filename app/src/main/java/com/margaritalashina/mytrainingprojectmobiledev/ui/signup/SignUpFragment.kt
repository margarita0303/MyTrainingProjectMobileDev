...
class SignUpFragment : BaseFragment(R.layout.fragment_sign_up) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // просим систему открыть приложение, которое может просмотреть передаваемые данные
    ...
    // мы хотим, чтобы у нас была строка, внутри которой содержится разметка
    // чтобы часть строки стала ссылкой
